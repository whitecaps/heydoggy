...
private
	...
	def user_params
		params.require(:user).permit(:name, :email, :password, :password_confirmation, :image, :breed, :gender, :birthday, :favourite_toy, :favourite_pasttime, :reason_loved, :friends_character, :favourite_dog, :display_email)
	end
end
